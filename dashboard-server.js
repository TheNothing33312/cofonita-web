...
const checkAuth = async (req, res, next) => {
    ...
    // Redirigir al login
    return res.redirect(`${MAIN_SERVER_URL}/login?redirect=${encodeURIComponent(req.originalUrl)}`);
};
        ...
        res.status(500).send(`
            ...
            <body>
                <div class="error-container">
                    ...
                    <a href="${MAIN_SERVER_URL}/dashboard" class="btn">
                        <i class="fas fa-redo"></i> Reintentar
                    </a>
                    <a href="${MAIN_SERVER_URL}/login" class="btn" style="margin-left: 10px;">
